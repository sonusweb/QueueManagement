...
{
    public partial class ReportAvgWaitTime : System.Web.UI.Page
    {
        QueueDataHelper qdh;
        int ClientID;
        ...
        protected void LoadReport(int clientID)
        {
            ...
            ds = SqlHelper.ExecuteDataset(connect,
                                "spQM_GetAvgTimeByDateClient", prms);

            ReportDataSource dataSource = new ReportDataSource("dsQueue_spQM_GetAvgTimeByDateClient",
                                    ds.Tables[0]);
